        ...
        <div className="grid gap-6 py-4">
            ...
            <div className="bg-green-50 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-lg font-bold text-green-600">{batch.template_id}</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-gray-900 ml-6">{batch.created_by}</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-gray-900 ml-6">{batch.approved_by || "Chưa duyệt"}</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-medium text-gray-900 ml-6">
                  {batch.approved_at ? new Date(batch.approved_at).toLocaleDateString("vi-VN") : "Chưa duyệt"}
                </p>
              </div>
            </div>
          </div>
          ...
          {batch.note && (
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 bg-white rounded-md p-3 border border-gray-200">
                {batch.note}
              </p>
            </div>
          )}
