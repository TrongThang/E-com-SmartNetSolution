...
export default function ChangePassword() {
    ...
    const { changePasswordEmployee } = useAuth();
    ...
    const handleChangePassword = async (e) => {
        ...
        if (validateForm()) {
            ...
            setLoading(true);
            try {
                const result = await changePasswordEmployee(formData.currentPassword, formData.newPassword, formData.confirmPassword);
                if (result.success) {
                    setTimeout(() => {
                        setIsSuccess(true)
                    }, 500)
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-4">
                <div className="max-w-7xl">
                    <div className="flex items-center">
                        <Link to="/admin/profile" className="mr-4">
