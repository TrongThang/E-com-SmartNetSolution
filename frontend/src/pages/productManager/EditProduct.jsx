...
const EditProductPage = () => {
    ...
    const [product, setProduct] = useState({
        ...
        specifications: [
            ...
            { name: "Tính năng thông minh", value: "" },
    ...
    const availableAttributes = [
        ...
        { id: 4, name: "Tính năng thông minh", type: "attribute", parent: 1 },
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-muted-foreground">236</span>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Button variant="outline" size="sm" className="px-6 bg-black text-white hover:opacity-70 flex items-center gap-1" onClick={() => setShowAddAttributeDialog(true)}>
                        ...
                        <Card className="p-6">
                            <h3 className="mb-4 font-medium">Thông số kỹ thuật</h3>
