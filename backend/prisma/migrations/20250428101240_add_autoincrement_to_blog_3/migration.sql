/*
  ...
  - You are about to alter the column `author` on the `blog` table. The data in that column could be lost. The data in that column will be cast from `VarChar(50)` to `VarChar(12)`.
...
-- AlterTable
ALTER TABLE `blog` MODIFY `author` VARCHAR(12) NULL;
