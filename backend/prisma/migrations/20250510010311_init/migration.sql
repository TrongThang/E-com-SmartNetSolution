...
<<<<<<<< HEAD:backend/prisma/migrations/20250509100448_init/migration.sql
    `id` INTEGER NOT NULL,
========
    `id` INTEGER NOT NULL AUTO_INCREMENT,
>>>>>>>> 2ac7d74ca100f566c67e5c2074905d48f0485536:backend/prisma/migrations/20250510010311_init/migration.sql
    `account_id` VARCHAR(32) NULL,
