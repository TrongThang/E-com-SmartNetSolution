...
-- AlterTable
ALTER TABLE `contact` ADD COLUMN `status` TINYINT NULL,
...
-- AlterTable
ALTER TABLE `slideshow` MODIFY `id` INTEGER NOT NULL AUTO_INCREMENT;
...
-- AlterTable
ALTER TABLE `warrenty_time` MODIFY `id` INTEGER NOT NULL AUTO_INCREMENT;
