...
// quên mật khẩu
authRouter.post('/forgot-password/send-otp', asyncHandler(sendOtpForgotPassword));
authRouter.post('/forgot-password/verify-otp', asyncHandler(verifyOtpForgotPassword));
